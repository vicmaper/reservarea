...
<html>
    ...
    <g:img dir="images" file="salones.jpg" width="1380" height="300"/>
        ...
        <div id="edit-solicitud" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.solicitud}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.solicitud}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.solicitud}" method="PUT">
                <g:hiddenField name="version" value="${this.solicitud?.version}" />
                <fieldset class="form">
                    <f:all bean="solicitud"/>
                </fieldset>
